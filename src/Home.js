      ...
      <div className="home__container">
        ...
        <div className="home__row">
          <Product
            ...
            rating={5}
            image={
              "https://149349112.v2.pressablecdn.com/wp-content/uploads/2020/06/41mJi5S7AkL.jpg"
            }
          />
          <Product
            id="4673890"
        ...
        <div className="home__row">
          ...
          <Product
            ...
            rating={4}
            image={
              "https://images-na.ssl-images-amazon.com/images/I/816ctt5WV5L.AC_SX385_.jpg"
            }
          />
        </div>
        <div className="home__row">
